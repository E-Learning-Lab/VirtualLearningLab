...
DEBUG = True
ALLOWED_HOSTS = ['sudo nginx -t && sudo systemctl restart nginx','radiant-meadow-94865.herokuapp.com', '207.154.236.200', 'wwww.elearning-lab.org', 'elearning-lab.org','virtual-learning-lab.herokuapp.com', '127.0.0.1']
